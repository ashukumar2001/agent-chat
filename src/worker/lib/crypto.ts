...
export const getEncryptionKeyFromString = async (keyString: string): Promise<CryptoKey> => {
...
export const encryptString = async (plaintext: string, keyString: string): Promise<string> => {
...
export const decryptString = async (ciphertextBase64: string, keyString: string): Promise<string> => {
