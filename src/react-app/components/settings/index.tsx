...
type SettingsMobileNavigationProps = {
...
type SettingsMobileContentProps = {
...
function SettingsMobileContent({
  ...
  return (
    <div className="flex flex-col h-full">
      ...
      <div className="flex-1 p-4 pb-8 overflow-y-auto">{children}</div>
    </div>
  );
}
