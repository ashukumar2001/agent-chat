/* eslint-disable */
// Generated by Wrangler by running `wrangler types -e development` (hash: a9b5e0b2add39a8a860f58f4fc69e0e1)
// Runtime types generated with workerd@1.20251105.0 2025-04-01 nodejs_compat,nodejs_compat_populate_process_env
declare namespace Cloudflare {
	interface GlobalProps {
		mainModule: typeof import("./src/worker/index");
		durableNamespaces: "ChatAgent" | "UserSettings";
	}
	interface Env {
		...
		VITE_DODO_PRO_PRODUCT_ID: string;
		PRO_PLAN_FAST_MODEL_REQUESTS: string;
		PRO_PLAN_PREMIUM_MODEL_REQUESTS: string;
		ChatAgent: DurableObjectNamespace<import("./src/worker/index").ChatAgent>;
		UserSettings: DurableObjectNamespace<import("./src/worker/index").UserSettings>;
		EDDY_AI_CHAT_DB: D1Database;
		AI: Ai;
	}
}
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "CLOUDFLARE_ENV" | "CLOUDFLARE_DATABASE_ID" | "CLOUDFLARE_ACCOUNT_ID" | "CLOUDFLARE_D1_TOKEN" | "BETTER_AUTH_SECRET" | "BETTER_AUTH_URL" | "DATA_ENCRYPTION_KEY" | "GITHUB_CLIENT_ID" | "GITHUB_CLIENT_SECRET" | "GOOGLE_CLIENT_ID" | "GOOGLE_CLIENT_SECRET" | "GOOGLE_GENERATIVE_AI_API_KEY" | "DODO_PAYMENTS_API_KEY" | "DODO_PAYMENTS_WEBHOOK_KEY" | "DODO_PRO_PRODUCT_ID" | "VITE_DODO_PRO_PRODUCT_ID" | "PRO_PLAN_FAST_MODEL_REQUESTS" | "PRO_PLAN_PREMIUM_MODEL_REQUESTS">> {}
}
